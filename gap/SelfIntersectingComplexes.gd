...
DeclareGlobalFunction("ComponentsOuterHullCombinatorics");
...
DeclareGlobalFunction("calculate_intersections_comp");

DeclareGlobalFunction("calculate_intersections");

DeclareGlobalFunction("calculate_intersections_groups");
